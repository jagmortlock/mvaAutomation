...
so that I can track my allowances usage.
   ...
   Scenario: Scenario 7
         Given I am a "MyVF PAYG 1 >£1 spend" user
         When action I am on the dashboard
         Then I should see the "main tile" displaying "MyVF PAYG 1 >£1 spend" cards horizontally scroll-able
            And clicking "allowances tile" takes me to "Usage tab"
   ...
   Scenario: Scenario 8
         ...
         When action I am on the dashboard
         Then I should see the "main tile" displaying "MyVF PAYG BVB" cards horizontally scroll-able
            And clicking "allowances tile" takes me to "Usage tab"
