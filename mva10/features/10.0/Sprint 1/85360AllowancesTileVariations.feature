...
Scenario: Scenario 1
 Given I am a  "MyVF PAYM" user
  ...
  Then I should see the "main tile" displaying "allowances" cards horizontally scroll-able
...
# GIVEN that, I am a MyVF MBB (PAYM& PAYG) user
# WHEN I am on the top tile of the dashboard
# THEN I should view the main tile displaying my allowances cards horizontally scroll-able
# AND allowance cards will show the aggregated domestic data, domestic minutes, domestic SMS, and international mins volume
# AND each allowance card should show the below info:
...
# Footer: Expiry/renewal date in case aggregated allowances all have the same expiry date  OR  “See your breakdown” text in case of different expiry dates
# Pips: indicated the number of cards, the card the user is currently on, and that cards are horizontally scroll-able
# AND clicking on the allowances tile should execute a journey to Usage tab in My Account



# GIVEN that, I am a MyVF HBB user
# WHEN I am on the top tile of the dashboard
# THEN I should view the main tile displaying my allowances cards horizontally scroll-able
# AND allowance cards will show the aggregated domestic data, domestic minutes, domestic SMS, and international mins volume
# AND each allowance card should show the below info:
...
# GIVEN that, I am a MyVF PAYG Simply user with allowances
# WHEN I am on the top tile of the dashboard
# THEN I should view the main tile displaying my allowances cards horizontally scroll-able
# AND allowance cards will show the aggregated domestic data, domestic minutes, domestic SMS, and international mins volume
# AND each allowance card should show the below info:
...
# GIVEN that, I am a MyVF PAYG Simply user with no allowances
# WHEN I am on the dashboard
# THEN I should not view the allowances tile



# GIVEN that, I am a MyVF PAYG 1 with <£1 spend user
# WHEN I am on the dashboard
# THEN I should not view the allowances tile
...
# GIVEN that, I am a MyVF PAYG with a BVB user
# WHEN I am on the top tile of the dashboard
# THEN I should view the main tile displaying my allowances cards horizontally scroll-able
# AND allowance cards will show the aggregated domestic data, domestic minutes, domestic SMS, and international mins volume
# AND each allowance card should show the below info:
